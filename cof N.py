...
def coffee(n):
    ...
    # if water_for_coffee>total_water:
    # print("not enough water")
    # situation=False

    if milk_for_coffee > total_milk:
            print("not enough milk")
            situation = False

    if coffee_beans > coffee_beans:
        print("not enough coffee")
        situation = False

def cost(cost_for_cofee):
    global money
    global situation

    rupee_10 = int(input("no. of 10 rupee note: "))
    rupee_50 = int(input("no. of 50 rupee note: "))
    rupee_100 = int(input("no. of 100 rupee note: "))

    total_money_entered = (rupee_10 * 10) + (rupee_50 * 50) + (rupee_100 * 100)

    if cost_for_cofee > total_money_entered:
        print("not enought money has been entered")
        print("money entered will be returned")
        situation = False

    elif cost_for_cofee == total_money_entered:
        print("money has been deposited")
        money += cost_for_cofee

    elif cost_for_cofee < total_money_entered:
        k = total_money_entered - cost_for_cofee
        print("money has been deposited")
...
while situation:
    print("""press
        ...
        4 for latte
        5 for cappuccino
        6 to see amount of money machine currently possess""")
    ...
    if choice == 1:
        ...
        n = "cappuccino"
        print(f"cost for espresso is {cost_cappuccino}")
